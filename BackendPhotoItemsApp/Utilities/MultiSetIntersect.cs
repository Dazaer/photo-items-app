...
//namespace BackendPhotoItemsApp.Utilities {

//    public static class MultisetIntersect {

//        public static IEnumerable<T> Intersect(this IEnumerable<T> first, IEnumerable<T> second) {
//            // Call the overload with the default comparer.
//            return first.Intersect(second, EqualityComparer<T>.Default);
//    }

//    public static IEnumerable<T> Intersect(this IEnumerable<T> first,
...
//    private static IEnumerable<T> IntersectImplementation(
